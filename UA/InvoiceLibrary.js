...
softline.checkSummInvoice = function (context) {
    ...
    if (Xrm.Page.getAttribute('totalamount').getValue() != null && Xrm.Page.getAttribute('paymenttermscode').getValue() != '35'
        ...
        if (payStatus == '33' && summInvoice > constanta[0].attributes["new_invoiceprepayment"].value) {
