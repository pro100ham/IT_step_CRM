          ...
          annotation.FileName.ToString());
            ...
            for (int i = 2; i < exel.Tables[0].Rows.Count; i++)
            {
                ...
                if (exel.Tables[0].Rows[i][0].ToString() != string.Empty)
                {
                    ...
                    invoicedetail.Exchangerates = exel.Tables[0].Rows[i][12].ToString();
            ...
            //decimal discount = (from i in invoice
            ...
            using (var orgContext = new OrganizationServiceContext(service))
            {
                ...
                var updateInvoice = new Invoice()
                {
                    ...
                    new_morginpercentage = percent == 0 ? 0 : (invoiceMain.new_morginpercentage ?? 0 + percent) * 100,
