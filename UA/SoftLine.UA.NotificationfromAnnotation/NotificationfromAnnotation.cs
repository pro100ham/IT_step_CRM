            ...
            try
            {
                ...
                switch (annotation.ObjectId.LogicalName.ToLower())
                {
                    case new_supplementaryagreement.EntityLogicalName /*Доп. соглашения*/:
                        ...
                        Subject = "Создано примечание к Доп. соглашения №" + GetEntityName<new_supplementaryagreement>(annotation.ObjectId.Id, service);
                    ...
                    case Invoice.EntityLogicalName:
                        ...
                        Description += ("Текст примечания : ");
                        Description += ("\"" + annotation.NoteText + "\"");
                        Subject = "Создано примечание к КИЗ №" + GetEntityName<Invoice>(annotation.ObjectId.Id, service);
                    ...
                    case new_coordinationcontract.EntityLogicalName /*Согласование договора*/:
                        ...
                        Description += ("Текст примечания : ");
                        Description += ("\"" + annotation.NoteText + "\"");
                        Subject = "Создано примечание к согласования Договора №" + GetEntityName<new_coordinationcontract>(annotation.ObjectId.Id, service);
