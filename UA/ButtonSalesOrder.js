...
softline.ButtonSalesOrder = function () {
    if (Xrm.Page.data.entity.getId() != "") {
        var coordinationcontract = retrieveRecord(Xrm.Page.data.entity.getId());
        ...
        if (coordinationcontract.length != 0) {
            ...
            if (coordinationcontract[length - 1].attributes["new_datecoordination"])
                parameters["new_datecoordination"] = coordinationcontract[length - 1].attributes["new_datecoordination"].value.format('yyyy-MM-dd');
            ...
            if (coordinationcontract[length - 1].attributes["new_datecoordinationlaw"])
                parameters["new_datecoordinationlaw"] = coordinationcontract[length - 1].attributes["new_datecoordinationlaw"].value.format('yyyy-MM-dd');
            ...
            if (coordinationcontract[length - 1].attributes["new_datecoordinationlog"])
                parameters["new_datecoordinationlog"] = coordinationcontract[length - 1].attributes["new_datecoordinationlog"].value.format('yyyy-MM-dd');
            ...
            if (coordinationcontract[length - 1].attributes["new_datecoordinationlac"])
                parameters["new_datecoordinationlac"] = coordinationcontract[length - 1].attributes["new_datecoordinationlac"].value.format('yyyy-MM-dd');
...
var retrieveRecord = function (salesorderId) {
    var queryOptions = {
